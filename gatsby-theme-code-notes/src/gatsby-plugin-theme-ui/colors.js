...
const lightTheme = {
  ...
  codeblockHighlightLine: 'hsl(231, 15%, 25%)',
  codeblockAddLine: 'hsl(112, 25%, 18%)',
  codeblockAddLineText: 'hsl(112, 25%, 38%)',
  codeblockRemoveLine: 'hsl(1, 30%, 18%)',
  codeblockRemoveLineText: 'hsl(1, 30%, 38%)',
  codeblockHighlightBorder: 'hsl(231, 15%, 15%)',
  codeFileText: '#718096',
  copyCodeText: '#4a5568',
